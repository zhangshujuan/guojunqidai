...
Vcity._m = {
  ...
  clickCallBack: function(cityName) {
...
(function() {
  ...
  if (!Vcity.oCity) {
    ...
    for (var i = 0, n = citys.length; i < n; i++) {
      ...
      Vcity.cityIDDic[match[1]] = match[4];
  ...
  linkEvent: function() {
    ...
    for (var i = 0, n = links.length; i < n; i++) {
      links[i].onclick = function() {
        ...
        Vcity._m.clickCallBack(Vcity.cityIDDic[this.innerHTML]);
      }
    }
  },

  getCityIDByCityName: function() {
    Vcity.citys
  },
